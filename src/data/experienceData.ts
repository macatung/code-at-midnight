...
export const experienceData: ExperienceItem[] = [
  {
    ...
    technologies: ['React 18', 'TypeScript', 'Go', 'Rust WASM', 'Docker', 'WebSockets', 'TailwindCSS'],
  ...
  },
  {
    ...
    achievements: [
      'Migrated legacy monolithic UI to Next.js modular architecture, accelerating page initial loads by 64%.',
    ...
    technologies: ['Next.js', 'Node.js', 'PostgreSQL', 'Redis', 'AWS', 'GraphQL', 'Jest/Playwright'],
  ...
  },
  {
    ...
    technologies: ['Three.js', 'Canvas 2D', 'React', 'GSAP', 'WebGL', 'Web Audio API'],
