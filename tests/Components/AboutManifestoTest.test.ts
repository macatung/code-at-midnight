...
describe('AboutManifestoTest (F18)', () => {
  ...
  describe('[T1_F18] About Section Stats & 3-Tab Manifesto', () => {
    ...
    it('[T1_F18_01] Developer stats grid renders 4 distinct metrics cards', () => {
      ...
      expect(labels).toContain('Midnight Coffees Brewed');
      expect(labels).toContain('Bugs Exorcised');
      expect(labels).toContain('Hop Velocity');
      expect(labels).toContain('Code Shipped at 12AM');
    });
