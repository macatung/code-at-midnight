...
export const skillsData: SkillCategory[] = [
  {
    ...
    skills: [
      { name: 'Vue 3 / React / Next.js', level: 96, rune: '⚛️', tag: 'Core', description: 'Composition API, reactive state, concurrent rendering & performance optimization.' },
  ...
  },
  {
    ...
    skills: [
      { name: 'PHP / Laravel / Node.js', level: 93, rune: '🐘', tag: 'Backend', description: 'Inertia.js full-stack monoliths, Eloquent ORM, event loops & microservices.' },
      ...
      { name: 'PostgreSQL & SQLite', level: 90, rune: '🗄️', tag: 'Database', description: 'Complex CTEs, indexing strategies, time-series partitioning, pgvector embeddings.' },
